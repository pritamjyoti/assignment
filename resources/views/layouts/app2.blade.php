...
<?php /*    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Customer Panel') }}
                </a>
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" onclick="event.preventDefault();
                                 ...
                                 {{ Auth::guard('font')->user()->name }},     Logout
                                </a>
                            ...
                            <?php if(Gate::allows('authorize_menu', Auth::user())){  ?>
                            
                            <li class="nav-item">
                                    <a class="nav-link" href="{{ route('act.index') }}">Act & Rules</a>
                                </li>
                          <?php } ?>
                        @endguest
                    </ul>
